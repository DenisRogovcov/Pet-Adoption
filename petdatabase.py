...
img = Image.open('/Users/Denis/Desktop/proj_imgs/petimg.png')
...
# upperFrame
upframe = LabelFrame(Mainframe, bd=2, relief=RIDGE, bg='linen', text='Add Pets', font=('times new roman', 15, 'bold'),
                     fg='dark orange')
upframe.place(x=1, y=10, width=1390, height=110)

# down Frame
downframe = LabelFrame(Mainframe, bd=2, relief=RIDGE, bg='linen', text='Pets for Adoption',
                       font=('times new roman', 15, 'bold'), fg='dark orange')
...
Ptable = ttk.Treeview(tableframe, column=('id', 'brd', 'age', 'gend', 'prc'), xscrollcommand=scroll_x.set,
...
# Adopt Button
adopt_button = Button(downframe, text='Adopt Pet', fg='DarkOrange3', highlightbackground='linen', width=15,
                      command=adopt)
